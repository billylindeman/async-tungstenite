...
/// Wraps gio::SocketConnection for Async/Futures
...
/// SocketListener wraps gio::SocketListener
...
impl SocketListener {
    ...
    /// Add a gio::SocketAddress to listen on
    ...
    /// Accept a new conneciton asynchronously
...
/// Wrapper struct for a new socket connection asynchronously coming from the SocketListener
#[pin_project]
